...
exports.sendNotificationOnCreate = onDocumentCreated(
  ...
  async (event) => {
    try {
      ...
      // NO incluir android.notification - causa que Android muestre notificación vacía
      ...
      const message = {
        data: fcmData,
        tokens: fcmTokens,
        // ✅ NO notification a nivel raíz - MyFirebaseMessagingService.kt maneja las notificaciones
