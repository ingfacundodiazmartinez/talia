        ...
        return Scaffold(
            ...
            children: [
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, chatsSnapshot) {
                    ...
                    if (chatsSnapshot.hasData) {
                      chatCount = chatsSnapshot.data!.docs.where((doc) {
                        final data = doc.data() as Map<String, dynamic>;
                        final deletedBy = List<String>.from(data['deletedBy'] ?? []);
                        return !deletedBy.contains(user.uid);
                      }).length;
                    }
              ...
              Expanded(
                child: FutureBuilder<List<String>>(
                  future: ChatPermissionService().getBidirectionallyApprovedContacts(user.uid),
          ...
          _buildProfileOption(
            ...
            onTap: () async {
              ...
              if (confirm == true) {
                try {
                  // Limpiar token FCM y actualizar estado offline
                  if (_auth.currentUser != null) {
                    await _firestore
                        ...
                        .update({
                          ...
                          'fcmToken': null, // Limpiar token FCM para que no lleguen notificaciones a este dispositivo
