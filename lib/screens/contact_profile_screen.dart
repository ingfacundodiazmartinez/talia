...
class _ContactProfileScreenState extends State<ContactProfileScreen>
  ...
  void _setupControllerCallbacks() {
    ...
    // Callback para cuando un hijo intenta desbloquear un contacto bloqueado por el padre
    _controller.onParentBlocked = () {
      if (mounted) {
  ...
  /// Mostrar diálogo cuando un hijo intenta desbloquear un contacto bloqueado por el padre
