...
/// Card para mostrar una solicitud aprobada
///
/// Muestra:
...
class ApprovedRequestCard extends StatelessWidget {
  ...
  final Function(String, String, String, String, Map<String, dynamic>) onRevoke;
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        final contactPhone = details['contactPhone'];
        ...
        children: [
          ...
          OutlinedButton.icon(
            onPressed: isProcessing
                ? null
                : () => onRevoke(requestId, childId, contactName, type, data),
            icon: isProcessing
                ? SizedBox(
                    width: 12,
                    height: 12,
            ...
            label: Text(isProcessing ? 'Procesando' : 'Revocar'),
  ...
  Future<Map<String, dynamic>> _getRequestDetails(
    ...
    if (type == 'contact') {
      ...
      // Para solicitudes aprobadas, usar contactId directamente
