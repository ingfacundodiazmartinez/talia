...
class MarkMessagesReadService {
  ...
  Future<({bool success, String message})> call({
    ...
    try {
      ...
      // ⚠️ LEGACY (V1): Este servicio actualiza readBy[] en cada mensaje
      // Para mejor rendimiento, usar ReadReceiptsService.markMessagesAsSeen() (V2)
      // que solo actualiza lastOpenedAt en el chat/group doc
