...
/// Widget para diseño responsivo condicional
...
/// Widget para diferentes layouts según el tamaño
...
/// Widget que ajusta el padding basado en el tamaño del dispositivo
class ResponsivePadding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final padding = ResponsiveUtils.valueByDevice(
      context,
      small: small ?? const EdgeInsets.all(12.0),
      medium: medium ?? const EdgeInsets.all(16.0),
      large: large ?? const EdgeInsets.all(20.0),
